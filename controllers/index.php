...
class Index extends Controller 
{
    ...
    function updateYearLevel()
    {
		...
		$model->getDb()->truncate("student_yearlevel_update");
		$model->getDb()->update("student_academic_details", array("schoolyear" => $previousSchoolYear), "schoolyear = '".$model->currentSchoolYear()."'");
		$model->getDb()->insert("student_yearlevel_update", array("schoolyear" =>  ($year - 1) . "-" . $year));
