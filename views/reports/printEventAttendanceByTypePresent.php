...
<table style="width: 100%; margin-bottom: 20px;">
	<tbody>
		<tr>
			<td class="text-right" style="width: 10%"><img style="width: 100px" src="<?php echo URL; ?>public/logo1.png" /></td>
			<td style="width: 80%">
				<h2 class="text-center text-bold">Southland College</h2>
			...
			<td style="width: 10%"><img style="width: 100px" src="<?php echo URL; ?>public/logo1.png" /></td>
		</tr>
	</tbody>
</table>
