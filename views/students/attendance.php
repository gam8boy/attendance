...
<div class="row">
	<div class="col-md-12">
		<p class="text-right">
			<a class="btn btn-primary" target="_blank" href="<?php echo URL; ?>students/printAttendance/<?php echo $this->studentInfo['studentid']; ?>"><i class="fa fa-print"></i> Print</a>
		</p>
		<div class="box box-solid box-primary">
			<div class="box-header with-border">
				<h4 class="box-title">Name: <?php echo ucwords($this->studentInfo['lastname']); ?>, <?php echo ucwords($this->studentInfo['firstname']); ?><?php echo ($this->studentInfo['middlename'] != "") ? " " . strtoupper(substr($this->studentInfo['middlename'], 0, 1)) . ". " : " "; ?></h4>
			</div>
			<div class="box-body">				
